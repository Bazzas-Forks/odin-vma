...
create_vulkan_functions :: proc(vtable: vk.VTable) -> VulkanFunctions {
	return(
		{
			AllocateMemory                        = vtable.AllocateMemory,
			BindBufferMemory                      = vtable.BindBufferMemory,
			BindBufferMemory2KHR                  = vtable.BindBufferMemory2,
			BindImageMemory                       = vtable.BindImageMemory,
			BindImageMemory2KHR                   = vtable.BindImageMemory2,
			CmdCopyBuffer                         = vtable.CmdCopyBuffer,
			CreateBuffer                          = vtable.CreateBuffer,
			CreateImage                           = vtable.CreateImage,
			DestroyBuffer                         = vtable.DestroyBuffer,
			DestroyImage                          = vtable.DestroyImage,
			FlushMappedMemoryRanges               = vtable.FlushMappedMemoryRanges,
			FreeMemory                            = vtable.FreeMemory,
			GetBufferMemoryRequirements           = vtable.GetBufferMemoryRequirements,
			GetBufferMemoryRequirements2KHR       = vtable.GetBufferMemoryRequirements2,
			GetImageMemoryRequirements            = vtable.GetImageMemoryRequirements,
			GetImageMemoryRequirements2KHR        = vtable.GetImageMemoryRequirements2,
			GetPhysicalDeviceMemoryProperties     = vtable.GetPhysicalDeviceMemoryProperties,
			GetPhysicalDeviceMemoryProperties2KHR = vtable.GetPhysicalDeviceMemoryProperties2,
			GetPhysicalDeviceProperties           = vtable.GetPhysicalDeviceProperties,
			InvalidateMappedMemoryRanges          = vtable.InvalidateMappedMemoryRanges,
			MapMemory                             = vtable.MapMemory,
			UnmapMemory                           = vtable.UnmapMemory,
		} \
	)
}
